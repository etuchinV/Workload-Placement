...
import styles from "./SameProvider.module.css";

export type SameProviderType = {
  className?: string;
};

const SameProvider: FunctionComponent<SameProviderType> = ({
  className = "",
}) => {
  return (
    <div className={[styles.sameProvider, className].join(" ")}>
      <img
      ...
      <section className={styles.frameParent}>
        <div className={styles.frameWrapper}>
          <div className={styles.screenshot202406261347102Parent}>
            <img
        ...
        <div className={styles.frameGroup}>
          <div className={styles.questionAndOptionsParent}>
                ...
                <div className={styles.question}>
                  <div className={styles.text}>
                    <div className={styles.textHeading}>
                      Will same components for all environments (Np/PLE/Prod) be
                      in the same provider? (hint: Np in cloud, prod on premise)
                    </div>
                      ...
                      <div className={styles.component}>
                        <div className={styles.multiSelectOption21}>
                          <div className={styles.text2}>
                            <div className={styles.textHeading2}>Text</div>
                          </div>
