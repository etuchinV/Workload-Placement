...
import styles from "./DataRegulationYes.module.css";

const DataRegulationYes = ({ className = "" }) => {
  ...
  const onBackQuestionArrowClick = useCallback(() => {
    navigate("/data-regulation-check-screen");
  }, [navigate]);

  return (
    <div className={[styles.allRestricted, className].join(" ")}>
      <img
                    ...
                    <div className={styles.question}>
                      <div className={styles.text}>
                        <div className={styles.textHeading}>
                          Is all of the data associated with this workflow
                          restricted?
                        </div>
...
DataRegulationYes.propTypes = {
  className: PropTypes.string,
};

export default DataRegulationYes;
